"""Map the feasibility/quality frontier -- the stochastic view (benchmark).
...
how fast? ceiling.py draws the same frontier with the *complete* solver.
"""
...
def frontier(container, n, thresholds, tries=20):
    full = container.lexicon.load("scored", n)
...
if __name__ == "__main__":
    ...
    frontier(container, n, ts, tries=tries)
