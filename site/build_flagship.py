...
.cell.donor{outline:2px solid rgba(240,214,155,.5);outline-offset:-2px}
...
.thread .edge{fill:none;stroke:var(--logic-dim);stroke-width:.022;stroke-dasharray:.09 .07;stroke-linecap:round;transition:stroke .3s,stroke-width .3s}
.thread .edge.live{stroke:var(--logic);stroke-width:.05;stroke-dasharray:none;filter:drop-shadow(0 0 2px var(--logic))}
.thread .edge.hot{stroke:var(--given);stroke-width:.05;stroke-dasharray:none}
.thread .node{fill:var(--panel);stroke:var(--logic-dim);stroke-width:.028;transition:fill .3s,stroke .3s}
.thread .node.live{fill:var(--logic);stroke:var(--logic);filter:drop-shadow(0 0 3px var(--logic))}
