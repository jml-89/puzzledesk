...
(function(){
  ...
  deduced.forEach(function(e){
    var cn=centroid(e);e._donors=donors(e);
    e._donors.forEach(function(x){var ln=svg("line");
      ln.setAttribute("x1",x[1]+0.5);ln.setAttribute("y1",x[0]+0.5);
      ln.setAttribute("x2",cn[0]);ln.setAttribute("y2",cn[1]);
      ln.setAttribute("class","edge");ln.setAttribute("data-e",e.label);edgesG.appendChild(ln);});
    var nd=svg("circle");nd.setAttribute("cx",cn[0]);nd.setAttribute("cy",cn[1]);nd.setAttribute("r",".11");
