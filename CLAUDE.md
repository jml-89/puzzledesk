...
session + `SolverAgent` → `SolveService`, D24 — a Claude agent solving in a feedback
...
uv run --extra clue solve --reveal     # a tool: a Claude agent solves a generated puzzle (D24; needs a key)
